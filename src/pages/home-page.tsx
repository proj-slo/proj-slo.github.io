...
import { Bot, Sparkle, Terminal } from "lucide-react";
import { useRouter } from "@/hooks/use-router";

const DEBUG = false;

const header = `## Writing Effective Learning Outcomes
    ...
    <ScrollArea className="h-full overflow-y-auto">
      <div className="max-w-2xl mx-auto m-4 py-12 p-6">
        <div className="flex flex-col gap-4">
          ...
          <Alert className="cursor-pointer" onClick={() => navigate("write")}>
            <Sparkle className="h-4 w-4" />
            <AlertTitle>SOL Editor</AlertTitle>
            <AlertDescription>
              Write SOLs and improve them with AI.
            </AlertDescription>
          </Alert>
          ...
          >
            ...
            <AlertTitle>SOL Generator</AlertTitle>
            <AlertDescription>
              Generate SOLs for a given topic with AI.
            </AlertDescription>
          </Alert>
